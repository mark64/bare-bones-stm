...
help:
	...
	@echo "Individual projects are built into a _build-<project> directory"
	@echo "Output binary is located at _build-<project>/lk.bin"
	...
	@echo ""
	@echo "output will be in _build-testproject/"
